...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	...
	public static String[] stringToArray(Object value, String separatorChars) {
		...
		return split(value.toString(), separatorChars);
	}
	/**
	 ...
	 * @return
	 */
	public static String generatePh(String sjly) {
		String ph = sjly.toUpperCase()
				+ DateUtils.formatDate(new Date(), "yyyyMMddHHmmssSSS");
		return ph;
	}
}
